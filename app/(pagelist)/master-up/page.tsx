      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8">
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-white font-bold text-xl leading-tight">マスタup登録</h1>
              <p className="text-slate-400 text-xs mt-0.5">登録内容を入力してください</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div id="field-itemCode" tabIndex={-1} className="scroll-mt-6">
              ...
              <input type="text" name="itemCode" value={form.itemCode} onChange={handleChange} className={`${inputClass} font-mono tracking-wider`} />
